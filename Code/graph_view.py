...
def plot_graph(df_pontos: pd.DataFrame, df_ruas: pd.DataFrame, fig: Figure = None, route_log: list = None) -> Figure:
    """
...
def create_canvas(parent: tk.Widget, df_pontos: pd.DataFrame, df_ruas: pd.DataFrame, route_log: list = None) -> FigureCanvasTkAgg:
    """
...
if __name__ == "__main__":
    ...
    df_pontos = pd.read_csv("/home/pedrom/Documentos/SciTech/SciTech/Docs/Dataset de Test/datasets/hard/10/pontos.csv")
    df_ruas = pd.read_csv("/home/pedrom/Documentos/SciTech/SciTech/Docs/Dataset de Test/datasets/hard/10/ruas.csv")
